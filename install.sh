...
# Workaround for subsequent module installation failures due to magisk.img not
# mountable. This wraps abort() and uses two non-public API functions, thus is
# not future proof and should be updated alongside Magisk installation framework.
